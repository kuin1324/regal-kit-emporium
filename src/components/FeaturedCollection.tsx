...
const products = [
  ...
  { image: shirt5, name: "Italië Special Trainingsshirt", team: "Special Edition", year: "", price: "€30" },
  { image: shirt6, name: "Barcelona Special Flower Design", team: "FC Barcelona", year: "", price: "€30" },
];
