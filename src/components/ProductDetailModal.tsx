...
export const allProducts = [
  ...
  { image: ajaxRetroFront, gallery: [ajaxRetroFront, ajaxRetroBack], name: "Ajax Uit Shirt", nameKey: "ajaxRetro", team: "Ajax", leagues: ["Eredivisie", "Retro"], price: "€30", description: "Klassiek Ajax uit retro shirt met ABN AMRO.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["blauw", "geel"], availability: "ready" as const },
  { image: bayernRetroFront, gallery: [bayernRetroFront, bayernRetroBack], name: "Bayern Munich Shirt", nameKey: "bayernRetro", team: "Bayern München", leagues: ["Bundesliga", "Retro"], price: "€30", description: "Bayern München retro shirt met Opel sponsor.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["rood"], availability: "ready" as const },
  { image: liverpoolRedRetroFront, gallery: [liverpoolRedRetroFront, liverpoolRedRetroBack], name: "Liverpool Thuis Shirt", nameKey: "liverpoolRedRetro", team: "Liverpool", leagues: ["Premier League", "Retro"], price: "€30", description: "Liverpool thuis retro shirt met Reebok en Carlsberg.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["rood"], availability: "ready" as const },
  { image: liverpoolYellowRetroFront, gallery: [liverpoolYellowRetroFront, liverpoolYellowRetroBack], name: "Liverpool Tweede Uit Shirt", nameKey: "liverpoolYellowRetro", team: "Liverpool", leagues: ["Premier League", "Retro"], price: "€30", description: "Liverpool tweede uit retro shirt in geel met navy details.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["geel", "blauw"], availability: "ready" as const },
  { image: realMadridRetroFront, gallery: [realMadridRetroFront, realMadridRetroBack], name: "Real Madrid Thuis Shirt", nameKey: "realMadridRetro", team: "Real Madrid", leagues: ["La Liga", "Retro"], price: "€30", description: "Real Madrid thuis retro shirt met Teka sponsor.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["wit"], availability: "ready" as const },
  { image: arsenalSegaFront, gallery: [arsenalSegaFront, arsenalSegaBack], name: "Arsenal Uit Shirt", nameKey: "arsenalSegaRetro", team: "Arsenal", leagues: ["Premier League", "Retro"], price: "€30", description: "Klassiek Arsenal uit retro shirt met SEGA sponsor en Nike details.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["geel", "blauw"], availability: "ready" as const },
  { image: barcelonaRetroFront, gallery: [barcelonaRetroFront, barcelonaRetroBack], name: "Barcelona Thuis Shirt", nameKey: "barcelonaRetro", team: "FC Barcelona", leagues: ["La Liga", "Retro"], price: "€30", description: "FC Barcelona thuis retro shirt met iconische blaugrana strepen en Nike details.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["rood", "blauw"], availability: "ready" as const },
  { image: liverpoolCarlsbergFront, gallery: [liverpoolCarlsbergFront, liverpoolCarlsbergBack], name: "Liverpool Uit Shirt", nameKey: "liverpoolCarlsbergRetro", team: "Liverpool", leagues: ["Premier League", "Retro"], price: "€30", description: "Liverpool uit retro shirt met Reebok en Carlsberg.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["wit"], availability: "ready" as const },
  { image: psgOpelFront, gallery: [psgOpelFront, psgOpelBack], name: "Paris Thuis Shirt", nameKey: "psgOpelRetro", team: "Paris Saint-Germain", leagues: ["Ligue 1", "Retro"], price: "€30", description: "Klassiek PSG thuis retro shirt met OPEL sponsor en Nike details.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["blauw", "rood"], availability: "ready" as const },
  { image: realMadridAwayRetroFront, gallery: [realMadridAwayRetroFront, realMadridAwayRetroBack], name: "Real Madrid Thuis Shirt", nameKey: "realMadridAwayRetro", team: "Real Madrid", leagues: ["La Liga", "Retro"], price: "€30", description: "Real Madrid retro shirt in zwart met Realmadrid.com sponsor.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["zwart", "wit"], availability: "ready" as const },
];
