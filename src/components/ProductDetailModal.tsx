...
export const allProducts = [
  ...
  { image: realMadridAwayRetroFront, gallery: [realMadridAwayRetroFront, realMadridAwayRetroBack], name: "Real Madrid Thuis Shirt 2001/02", nameKey: "realMadridAwayRetro", team: "Real Madrid", leagues: ["La Liga", "Retro"], price: "€30", description: "Real Madrid retro shirt in zwart met Realmadrid.com sponsor.", sizes: ["S", "M", "L", "XL", "2XL"], colors: ["zwart", "wit"], availability: "ready" as const },
];
